...
<form action="controller.php" method="post">                
    <input type="hidden" name="description" id="description" value="<?php $titulo; ?>"/>                       
    <input type="hidden"name="transaction_amount" id="transaction_amount" value="<?php $precio;?> "/>
    <input type="hidden" name="imagen" id="imagen" value="<?php $imagen; ?>"/>
</form>
